...
if __name__ == "__main__":
    ...
    parser.add_argument('-ro', action='store_true', help='Execute "conan create"')
    argsparsed = parser.parse_args()
    main(not argsparsed.bo, argsparsed.em,  argsparsed.ro)
